...
$about = [
	'teaser' => 'VISL is focused on products and services that have been structured to meet every of your company’s/shipping needs such as the following: <a href="/about_us.php">Read More</a> ',
	'des' => ''
];
...
$services = [
	...
	'Diesel Bunker Supply' => [
		...
		'teaser' => 'We supply bunker fuels, lubricants AGO, PMS, IFO and related products and services.
				',
		'description' => ' VISL guarantees a reliable and compliant supply of marine diesel fuels, meeting
				the stringent standards of the industry. Our commitment to quality ensures optimal performance and environmental responsibility..
				 '
	],
	'Supply Chain Management (SCM)' => [
		'image' => 'gas_oil',
		'teaser' => 'Is the oversight of each step in the supply chain process, here we manage problems, purchases,',
		'description' => 'Leveraging cutting-edge technology, VISL optimizes supply chain processes for efficiency
		and cost-effectiveness. Our SCM services cover the entire logistics spectrum, ensuring seamless operations for our clients. '
	],
	'Marine Security Services' => [
		'image' => 'water',
		'teaser' => 'We provide adequate maritime security , escorts  with the help of Nigerian Navy .',
		'description' => "Security is paramount in maritime operations. VISL's dedicated team offers
		comprehensive marine security services, safeguarding vessels and personnel against potential threats, piracy, and unauthorized access.",

	],
	'Ship Store Suppliers' => [
		'image' => 'water',
		'teaser' => 'We offer the most comprehensive marine supply options available by combining..',
		'description' => 'Our ship store supply service offers a comprehensive range of provisions, from safety gear to
		daily consumables. VISL is the trusted partner for all vessel-related operational requirements.'
		,
	...
	'Ship-to-ship operation (STS)' => [
		...
		'description' => 'Facilitating safe and efficient ship-to-ship transfer operations, VISL ensures compliance
		with international regulations, enabling vessels to transfer fuel or cargo at sea with confidence.',
	...
	'  Deck Store Supply:' => [
		'image' => 'water',
		'teaser' => 'VISL supports seamless vessel functioning by providing a diverse array of deck store
		supplies,',
		'description' => 'VISL supports seamless vessel functioning by providing a diverse array of deck store
		supplies, including navigational equipment, safety gear, and maintenance tools.',
